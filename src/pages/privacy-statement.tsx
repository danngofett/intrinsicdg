  ...
  return (
    <Default siteMeta={response.site.siteMeta}>
      <Container className="prose prose-slate lg:prose-l" size="sm">
        ...
        <p>
          Intrinsic Development Group is committed to providing quality services
        ...
        <p>
          ...
          <a href="www.aoic.gov.au" target="_blank">
            www.aoic.gov.au
          </a>
        </p>
        ...
        <p>
          Intrinsic Development Group will not charge any fee for your access
